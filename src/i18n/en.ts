const en = {
  ...
  watermark: {
    ...
    presetStyles: {
      ...
      filmStamp: "Film stamp",
      rubyEditorial: "Ruby editorial",
      cyanMinimal: "Cyan minimal",
      monoArchive: "Mono archive",
      limeProof: "Lime proof",
      warmSerif: "Warm serif",
      blueCorner: "Blue corner",
      roseVertical: "Rose vertical",
      amberDate: "Amber date",
      silverLabel: "Silver label",
      mintCenter: "Mint center",
      noirBold: "Noir bold",
      violetMark: "Violet mark",
      tealScript: "Teal script",
      sandCaption: "Sand caption",
      redProof: "Red proof",
      iceTiny: "Ice tiny",
    },
    positions: {
